    ...
    <Transition name="fade">
      ...
      >
        ...
        >
          <!-- gradient blob -->
          <div
            class="absolute -top-20 -right-20 w-80 h-80 rounded-full blur-[120px] opacity-20 pointer-events-none"
            :class="gradientClass"
          />
          <div class="relative z-10 p-8 md:p-12 lg:p-16 flex flex-col items-center text-center">
            ...
            <div
              v-show="!success"
              class="w-full max-w-2xl space-y-10 transition-all duration-500"
            >
              <div class="flex flex-col items-center space-y-8">
                <div class="relative flex items-center justify-center">
                  ...
                  >
                    <iconify-icon
                      ...
                      class="text-4xl md:text-5xl animate-spin"
                      :class="gradientTextClass"
                    />
                  </div>
                  <svg
                    class="absolute w-36 h-36 md:w-40 md:h-40 -rotate-90"
                    viewBox="0 0 100 100"
                  >
                    <circle
                      cx="50"
                      cy="50"
                      r="48"
                      stroke="url(#loadingProgressGrad)"
                      stroke-width="4"
                      fill="transparent"
                ...
                <div class="space-y-3">
                  <h2
                    class="text-2xl sm:text-3xl md:text-5xl font-black uppercase italic tracking-tight text-white"
                  >
                    {{ statusText }}
                  </h2>
                  <div
                    class="flex flex-wrap justify-center gap-x-4 gap-y-1 text-white/40 font-medium text-sm"
                  >
                    <span>{{ fileName }}</span>
              ...
              <div class="space-y-4 w-full">
                <div class="flex justify-between items-end">
                  ...
                  <span
                    class="text-4xl md:text-5xl font-black tabular-nums tracking-tighter"
                    :class="gradientTextClass"
                  >
                    {{ Math.round(progress) }}%
                  </span>
                ...
                <div class="progress-track rounded-full overflow-hidden">
                  <div
                    class="progress-fill h-full rounded-full transition-[width] duration-150"
                    :class="gradientClass"
            ...
            <div
              v-show="success"
              class="w-full max-w-2xl space-y-8 animate-in fade-in zoom-in-95 duration-500"
            >
              <div class="flex flex-col items-center space-y-6">
                ...
                >
                  <iconify-icon
                    icon="lucide:check"
                    class="text-white text-6xl md:text-7xl"
                  />
                </div>
                <div class="space-y-2">
                  <h2
                    class="text-3xl md:text-5xl lg:text-6xl font-black uppercase italic text-white"
                  >
                    Download Ready!
                  </h2>
